...
1. Fork the `https://github.com/yubarajshrestha/masonite-audit` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/masonite-audit.git`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall masonite-audit && pip install .`
